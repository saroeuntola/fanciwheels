          ...
          <div class="footer-content">
              ...
              <div class="footer-section">
                  ...
                  <ul class="footer-links">
                      <li><a href="/?lang=<?= $lang ?>" class="footer-link"><?= $menu['home'] ?></a></li>
                      <li><a href="about?lang=<?= $lang ?>" class="footer-link"><?= $menu['about'] ?></a></li>
                      <li><a href="services?lang=<?= $lang ?>" class="footer-link"><?= $menu['services'] ?></a></li>
                      <li><a href="faq?lang=<?= $lang ?>" class="footer-link"><?= $menu['faq'] ?></a></li>
                  </ul>
              </div>
              <!-- Support -->
              <div class="footer-section">
                  ...
                  <ul class="footer-links">
                      ...
                      <li><a href="privacy-policy?lang=<?= $lang ?>"> <?= $lang === 'en' ? 'Privacy Policy' : 'গোপনীয়তার নীতি' ?></a></li>
                  </ul>
              </div>
