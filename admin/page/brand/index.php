...
<div class="container mx-auto lg:p-10">
    ...
    <div class="flex flex-col md:flex-row md:justify-between md:items-center mb-8">
        <h2 class="text-3xl font-extrabold text-gray-900 mb-4 md:mb-0">Brand Management</h2>
        <a href="create.php" 
                    ...
                    <?php foreach ($brands as $item): ?>
                        <tr class="bg-white border-b hover:bg-gray-50 transition">
                            <td class="px-6 py-4 font-medium text-gray-900">
                                <img src="<?= htmlspecialchars($item['brand_image']) ?>" alt="<?php echo ($item['name']); ?>" class="h-12 w-12 object-cover rounded-md">
                            </td>
                            <td class="px-6 py-4">
